...
public class CirculationEventListener extends ChannelListener {
	...
	public CirculationEventListener(CirculationTemperatureCallbacks callbacks, CirculationTemperature type, Channel channel) {
		super(channel);
